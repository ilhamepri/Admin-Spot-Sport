...
#ambil data di tabel dan masukkan ke array
	$query = "SELECT t.idtransaksi,dt.idbarang,t.tanggal,dt.qty,dt.harga,dt.subtotal FROM transaksi t,detail_pembayaran dt WHERE dt.idtransaksi=t.idtransaksi and tanggal BETWEEN '$tgl1' AND '$tgl2'";
